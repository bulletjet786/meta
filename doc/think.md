...
1. 修复翻译框过长的问题（minWidth）
2. 修改启动事件上传的问题(已完成)
3. 自更新机制（仅全量更新）(更新可能会有问题，是否修改桌面的Icon，不确定，也许可以)
4. 更加易用：评论区 + 区域翻译按钮(ReviewTranslatePlugin)

1. 硬件介绍、软件介绍、树莓派+内网穿透 路由器视频录制发布
